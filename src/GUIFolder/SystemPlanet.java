...
public class SystemPlanet extends JPanel {
	...
	public SystemPlanet(GUIWelcome frame, double speed) {
		...
		allPlanets.add(new PlanetGUI(this, "earth", 0, 0, 255, 800, 200, 11, 1.8, 0, 900));
		allPlanets.add(new PlanetGUI(this, "mars", 255, 0, 0, 850, 0, 7, 1.2, 0, 900));
		allPlanets.add(new PlanetGUI(this, "jupiter", 255, 140, 0, 800, -50, 20, 1.2, 0, 900));
		allPlanets.add(new PlanetGUI(this, "saturn", 112, 128, 144, 800, -75, 15, 1.2, 0, 900));
		allPlanets.add(new PlanetGUI(this, "uranus", 196, 233, 238, 800, -125, 15, 1.2, 0, 900));
	...
	private void gameLoop() {
		...
		while (true) {
			if (!stop) {
				...
				PlanetGUI sun = allPlanets.get(allPlanets.size() - 1);
